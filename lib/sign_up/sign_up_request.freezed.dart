...
class _$SignUpRequestImpl implements _SignUpRequest {
  ...
  @override
  String toString() {
    return 'SignUpRequest(firstName: $firstName, lastName: $lastName, username: $username, email: $email, password: $password)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, firstName, lastName, username, email, password);
